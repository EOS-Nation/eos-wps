...
# cleos push action $CONTRACT setstate '[{"current_voting_period": "2019-12-12T00:00:00", "liquid_deposits": "100.0000 EOS", "locked_deposits": "500.0000 EOS", "available_funding": "150.0000 EOS"}]' -p $CONTRACT
