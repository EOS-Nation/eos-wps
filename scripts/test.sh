...
# 1 day   = 86400
# 30 days = 2592000
cleos push action eosio.wps setparams '[{"vote_margin": 2, "deposit_required": "100.0000 EOS", "voting_interval": 120, "max_monthly_budget": "1000.0000 EOS", "min_time_voting_end": 10}]' -p eosio.wps
...
cleos -v push action eosio.wps activate '["toaccount", "short", "1970-01-01T00:00:00"]' -p toaccount
cleos -v push action eosio.wps activate '["toaccount", "novote", "1970-01-01T00:00:00"]' -p toaccount

# fund wps
cleos -v transfer eosio.ramfee eosio.wps "2000.0000 EOS" ""
